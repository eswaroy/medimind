...
const patientData = {
  ...
  about: "Ramesh Kumar, a 52-year-old retired teacher from Chennai, suffers from Type 2 diabetes and hypertension, often struggling with medication adherence and diet control while seeking better health management.",
